...
extern "C" void external_dce_flag_2();

extern "C" void external_dce_flag_3();

extern "C" void external_dce_flag_4();

extern "C" void external_dce_flag_5();
...
{
    __state->report.save("./out/smith_9/dcir/.dacecache/sdfg_0/perf", __HASH_sdfg_0);
    delete __state;
}
