...
./out/smith_9/dace/.dacecache/sdfg_0/build/CMakeFiles/sdfg_0.dir/home/xdb/AST/out/smith_9/dace/.dacecache/sdfg_0/src/cpu/sdfg_0.cpp.o:     file format elf64-x86-64
...
0000000000000000 <_Z25__program_sdfg_0_internalP8sdfg_0_tPi>:
  ...
  21:	e8 00 00 00 00       	callq  26 <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0x26>
  26:	e8 00 00 00 00       	callq  2b <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0x2b>
  2b:	e8 00 00 00 00       	callq  30 <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0x30>
  30:	c7 03 00 00 00 00    	movl   $0x0,(%rbx)
  36:	e8 00 00 00 00       	callq  3b <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0x3b>
  3b:	48 89 c1             	mov    %rax,%rcx
  3e:	48 be cf f7 53 e3 a5 	movabs $0x20c49ba5e353f7cf,%rsi
  45:	9b c4 20 
  48:	4c 89 f8             	mov    %r15,%rax
  4b:	48 f7 ee             	imul   %rsi
  4e:	49 89 d7             	mov    %rdx,%r15
  51:	48 89 c8             	mov    %rcx,%rax
  54:	48 f7 ee             	imul   %rsi
  57:	48 89 d3             	mov    %rdx,%rbx
  5a:	b8 01 00 00 00       	mov    $0x1,%eax
  5f:	48 83 3d 00 00 00 00 	cmpq   $0x0,0x0(%rip)        # 67 <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0x67>
  66:	00 
  67:	74 05                	je     6e <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0x6e>
  69:	e8 00 00 00 00       	callq  6e <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0x6e>
  6e:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
  73:	48 8d 7c 24 08       	lea    0x8(%rsp),%rdi
  78:	be 08 00 00 00       	mov    $0x8,%esi
  7d:	ba 07 69 0f c7       	mov    $0xc70f6907,%edx
  82:	e8 00 00 00 00       	callq  87 <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0x87>
  87:	4c 89 f9             	mov    %r15,%rcx
  8a:	48 c1 e9 3f          	shr    $0x3f,%rcx
  8e:	49 c1 ff 07          	sar    $0x7,%r15
  92:	49 01 cf             	add    %rcx,%r15
  95:	48 89 d9             	mov    %rbx,%rcx
  98:	48 c1 e9 3f          	shr    $0x3f,%rcx
  9c:	48 c1 fb 07          	sar    $0x7,%rbx
  a0:	48 01 cb             	add    %rcx,%rbx
  a3:	48 83 ec 08          	sub    $0x8,%rsp
  a7:	48 8d 35 00 00 00 00 	lea    0x0(%rip),%rsi        # ae <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0xae>
  ae:	48 8d 15 00 00 00 00 	lea    0x0(%rip),%rdx        # b5 <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0xb5>
  b5:	4c 89 f7             	mov    %r14,%rdi
  b8:	4c 89 f9             	mov    %r15,%rcx
  bb:	49 89 d8             	mov    %rbx,%r8
  be:	49 89 c1             	mov    %rax,%r9
  c1:	6a ff                	pushq  $0xffffffffffffffff
  c3:	6a ff                	pushq  $0xffffffffffffffff
  c5:	6a 00                	pushq  $0x0
  c7:	e8 00 00 00 00       	callq  cc <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0xcc>
  cc:	48 83 c4 30          	add    $0x30,%rsp
  d0:	5b                   	pop    %rbx
  d1:	41 5e                	pop    %r14
  d3:	41 5f                	pop    %r15
  d5:	c3                   	retq   
  d6:	48 89 c7             	mov    %rax,%rdi
  d9:	e8 00 00 00 00       	callq  de <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0xde>
  de:	66 90                	xchg   %ax,%ax

00000000000000e0 <__program_sdfg_0>:
  e0:	e9 00 00 00 00       	jmpq   e5 <__program_sdfg_0+0x5>
  e5:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
  ec:	00 00 00 
  ef:	90                   	nop

00000000000000f0 <__dace_init_sdfg_0>:
  f0:	50                   	push   %rax
  f1:	bf 40 00 00 00       	mov    $0x40,%edi
  f6:	e8 00 00 00 00       	callq  fb <__dace_init_sdfg_0+0xb>
  fb:	c5 f8 57 c0          	vxorps %xmm0,%xmm0,%xmm0
  ff:	c5 fc 11 00          	vmovups %ymm0,(%rax)
 103:	c5 fc 11 40 20       	vmovups %ymm0,0x20(%rax)
 108:	59                   	pop    %rcx
 109:	c5 f8 77             	vzeroupper 
 10c:	c3                   	retq   
 10d:	0f 1f 00             	nopl   (%rax)

0000000000000110 <__dace_exit_sdfg_0>:
 110:	53                   	push   %rbx
 111:	48 89 fb             	mov    %rdi,%rbx
 114:	48 8d 35 00 00 00 00 	lea    0x0(%rip),%rsi        # 11b <__dace_exit_sdfg_0+0xb>
 11b:	48 8d 15 00 00 00 00 	lea    0x0(%rip),%rdx        # 122 <__dace_exit_sdfg_0+0x12>
 122:	e8 00 00 00 00       	callq  127 <__dace_exit_sdfg_0+0x17>
 127:	48 85 db             	test   %rbx,%rbx
 12a:	74 17                	je     143 <__dace_exit_sdfg_0+0x33>
 12c:	48 8b 7b 28          	mov    0x28(%rbx),%rdi
 130:	48 85 ff             	test   %rdi,%rdi
 133:	74 05                	je     13a <__dace_exit_sdfg_0+0x2a>
 135:	e8 00 00 00 00       	callq  13a <__dace_exit_sdfg_0+0x2a>
 13a:	48 89 df             	mov    %rbx,%rdi
 13d:	5b                   	pop    %rbx
 13e:	e9 00 00 00 00       	jmpq   143 <__dace_exit_sdfg_0+0x33>
 143:	5b                   	pop    %rbx
 144:	c3                   	retq   
