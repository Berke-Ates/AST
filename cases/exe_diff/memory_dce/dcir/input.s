...
./out/smith_2/dcir/.dacecache/sdfg_0/build/CMakeFiles/sdfg_0.dir/home/xdb/AST/out/smith_2/dcir/.dacecache/sdfg_0/src/cpu/sdfg_0.cpp.o:     file format elf64-x86-64
...
0000000000000000 <_Z25__program_sdfg_0_internalP8sdfg_0_tPi>:
  ...
  1c:	c7 03 d4 5a 00 00    	movl   $0x5ad4,(%rbx)
  22:	e8 00 00 00 00       	callq  27 <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0x27>
  27:	48 89 c1             	mov    %rax,%rcx
  2a:	48 be cf f7 53 e3 a5 	movabs $0x20c49ba5e353f7cf,%rsi
  31:	9b c4 20 
  34:	4c 89 f8             	mov    %r15,%rax
  37:	48 f7 ee             	imul   %rsi
  3a:	49 89 d7             	mov    %rdx,%r15
  3d:	48 89 c8             	mov    %rcx,%rax
  40:	48 f7 ee             	imul   %rsi
  43:	48 89 d3             	mov    %rdx,%rbx
  46:	b8 01 00 00 00       	mov    $0x1,%eax
  4b:	48 83 3d 00 00 00 00 	cmpq   $0x0,0x0(%rip)        # 53 <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0x53>
  52:	00 
  53:	74 05                	je     5a <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0x5a>
  55:	e8 00 00 00 00       	callq  5a <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0x5a>
  5a:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
  5f:	48 8d 7c 24 08       	lea    0x8(%rsp),%rdi
  64:	be 08 00 00 00       	mov    $0x8,%esi
  69:	ba 07 69 0f c7       	mov    $0xc70f6907,%edx
  6e:	e8 00 00 00 00       	callq  73 <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0x73>
  73:	4c 89 f9             	mov    %r15,%rcx
  76:	48 c1 e9 3f          	shr    $0x3f,%rcx
  7a:	49 c1 ff 07          	sar    $0x7,%r15
  7e:	49 01 cf             	add    %rcx,%r15
  81:	48 89 d9             	mov    %rbx,%rcx
  84:	48 c1 e9 3f          	shr    $0x3f,%rcx
  88:	48 c1 fb 07          	sar    $0x7,%rbx
  8c:	48 01 cb             	add    %rcx,%rbx
  8f:	48 83 ec 08          	sub    $0x8,%rsp
  93:	48 8d 35 00 00 00 00 	lea    0x0(%rip),%rsi        # 9a <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0x9a>
  9a:	48 8d 15 00 00 00 00 	lea    0x0(%rip),%rdx        # a1 <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0xa1>
  a1:	4c 89 f7             	mov    %r14,%rdi
  a4:	4c 89 f9             	mov    %r15,%rcx
  a7:	49 89 d8             	mov    %rbx,%r8
  aa:	49 89 c1             	mov    %rax,%r9
  ad:	6a ff                	pushq  $0xffffffffffffffff
  af:	6a ff                	pushq  $0xffffffffffffffff
  b1:	6a 00                	pushq  $0x0
  b3:	e8 00 00 00 00       	callq  b8 <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0xb8>
  b8:	48 83 c4 30          	add    $0x30,%rsp
  bc:	5b                   	pop    %rbx
  bd:	41 5e                	pop    %r14
  bf:	41 5f                	pop    %r15
  c1:	c3                   	retq   
  c2:	48 89 c7             	mov    %rax,%rdi
  c5:	e8 00 00 00 00       	callq  ca <_Z25__program_sdfg_0_internalP8sdfg_0_tPi+0xca>
